  ...
  return (
    ...
    <div className="full">
      ...
      <div className="lista col-10">
        <div>
          <h2 className="Thema">Abouts US</h2>
        </div>
        ...
        <div className="accordion accordion-flush myAccordion" data-bs-theme="dark" id="accordionFlushExample">
          <div className="accordion-item">
            ...
            <div id="flush-collapseOne" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
              <div className="accordion-body">At Reel Rhapsody, our passion is to take you on an unforgettable cinematic journey. We are a passionate team of film lovers who believe that the best stories deserve to be shared. Are you looking for your next favorite movie? You are in the right place!.</div>
            </div>
          </div>
          ...
          <div className="accordion-item">
            ...
            <div id="flush-collapseTwo" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
              <div className="accordion-body">Facilitate free access to exceptional films. We want to make discovering new stories as easy as pressing play. At Reel Rhapsody, we believe in the magic of cinema to inspire, entertain and connect people.</div>
            </div>
          </div>
          ...
          <div className="accordion-item">
            ...
            <div id="flush-collapseThree" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
              <div className="accordion-body">Our team of experts carefully curates a selection of featured films. Whether you're looking for action, drama, comedy or any particular genre, we have something for every taste. The best part? It's completely free.</div>
            </div>
          </div>
          ...
          <div className="accordion-item">
            ...
            <div id="flush-collapsefour" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
              <div className="accordion-body">Reel Rhapsody is supported by the generosity of our community. If you love what we do and would like to support the continuation of this project, please consider making a donation. Every contribution helps us continue to provide quality content and improve your movie experience.
